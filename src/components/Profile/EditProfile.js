            ...
            <div className="left-form-part">
              ...
              <form onSubmit={onSubmit}>
                ...
                <input
                  ...
                  value={data.top1}
                  onChange={(e) =>
                    setData({ ...data, top1: e.target.value })
                  }
                  className="edit-input"
                  type="text"
                />
                ...
                <input
                  ...
                  value={data.top1A2}
                  onChange={(e) =>
                    setData({ ...data, top1A2: e.target.value })
                  }
                  className="edit-input"
                  type="text"
                />
                ...
                <input
                  ...
                  value={data.top1A3}
                  onChange={(e) =>
                    setData({ ...data, top1A3: e.target.value })
                  }
                  className="edit-input"
                  type="text"
                />
                ...
                <input
                  ...
                  value={data.top1A4}
                  onChange={(e) =>
                    setData({ ...data, top1A4: e.target.value })
                  }
                  className="edit-input"
                  type="text"
                />
                ...
                <input
                  ...
                  value={data.top1A5}
                  onChange={(e) =>
                    setData({ ...data, top1A5: e.target.value })
                  }
                  className="edit-input"
                  type="text"
                />
